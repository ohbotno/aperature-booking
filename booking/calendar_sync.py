...
class ICSCalendarGenerator:
    ...
    def generate_resource_calendar(self, resource, days_ahead=90):
        """Generate ICS calendar for a specific resource's bookings."""
        from .models import Booking
        ...
        return self._generate_ics(bookings_qs, f"{resource.name} - Aperture Booking")
